...
from m_types import MalBoolean, MalEOFError, MalEmptyExpr, MalHashMap, MalList, MalNil, MalNotFound, MalNumber, MalSymbol, MalType, MalVector
import reader
import printer
...
def EVAL(ast : MalType, repl_env):
    ...
    if debug in repl_env and repl_env[debug] not in (MalBoolean(False),MalNil()):
