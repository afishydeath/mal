...
from m_types import MalEOFError, MalEmptyExpr, MalFalse, MalFunction, MalHashMap, MalList, MalNil, MalNotFound, MalNumber, MalSymbol, MalType, MalVector
import reader
import printer
        ...
        match ast[0]:
            ...
            case MalSymbol("let*"):
                ...
                for i in range(0,len(ast[1]),2):
                    new_env.set(ast[1][i],EVAL(ast[1][i+1],new_env))
